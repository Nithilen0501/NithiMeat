        ...
        return (
          <div>
            ...
            marginBottom:"0px",
                ...
                <Flex w="80%"  gap="20px">
                    <Image src="1.jpg" margin="15px 15px 15px 15px" ></Image>
                    <Flex>
                        <Box margin="15px 0 0 -15px ">
                            <Heading size="xs" color="gray">Coimbatore</Heading>
                            <Flex gap="20px">
                                <Heading size="xs">Gandhipuram</Heading>
                ...
                <Flex w="80%" margin="auto">
                    ...
                    <Box>
                        <Flex gap="10px">
                            ...
                            <p size="xs">About</p>
                            <p size="xs">*</p>
                            <p size="xs">Careers @NithiMeats</p>
                        </Flex>
                    </Box>
                </Flex>
            </Box>
